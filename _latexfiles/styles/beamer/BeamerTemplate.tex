...
\usepackage{\mypath/styles/beamer/beamerthemeivt}
%\usepackage[style=alphabetic,babel=hyphen,backend=bibtex]{biblatex}
...
\newcommand{\mytitle}{Long Title}
\title[Short Title]{\mytitle}
\date{XXth XXX 20XX}
\institute[IVT, ETH Z\"urich]{\includegraphics[width=3cm]{\mypath /logos/ivt-logo-crop.pdf} \hspace{2cm} \includegraphics[width=3cm]{\mypath /logos/eth-logo-new.pdf}}
\author{Author }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\mykeywordsEN}{continuous target based model; long term simulation; long distance travel demand; microscopic travel demand simulation; C-TAP}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% The author 1
\newcommand{\myfirstauthor}{\author}
...
%\bibstyle{alpha}
%\nobibliography*
%\bibliography{\mypath bibs/all-eng}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
