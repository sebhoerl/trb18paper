...
In order to define the travel demand for the fleet of automated vehicles, agents have been tagged as for whether they are viable for using an automated vehicle or not.
