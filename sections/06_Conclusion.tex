...
trips that possibly could be undertaken by AV are converted to the automated
...
AV service can be analyszed including the tradeoff that people make between
