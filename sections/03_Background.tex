...
As the work does not detail the proposed dispatching algorithm for this strategy, we match
...
\item The last implemented strategy is derived from \cite{pavone2011load}. Instead of a pure
