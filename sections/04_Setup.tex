...
not result in a significant increase in service level. In \citep{zhang2016control}
 ...
 vehicles are present at that vertex. Computation of the mean availability of all
